...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      enrollInMatch: { Args: { targetMatchId: string }; Returns: string }
      getMatchParticipants: {
        Args: { targetMatchId: string }
        Returns: {
          avatarUrl: string
          firstName: string
          lastName: string
      ...
      isEnrollmentOrganizer: {
        Args: { target_enrollment_id: string }
        Returns: boolean
      }
      isMatchOrganizer: { Args: { target_match_id: string }; Returns: boolean }
    }
    Enums: {
      city: "ccs" | "mbo" | "vlc"
